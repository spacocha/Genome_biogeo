...
ma_op_rxns = [
    ...
    0.167   s(‘C’)   2   s('N+’)   1   s(‘null’)   1   s(‘CO2’)   1   s('N')   1   s(‘H2O’)   narG_sp_growth_rate   narG_half_sat_C   narG_half_sat_N   narG_deltaG0
    0.167   s(‘C’)   1.333   s(’N’)   1.333   s(‘H’)   1   s(‘CO2’)   0.67   s(‘N2’)   1.67   s(‘H2O’)   nirK_sp_growth_rate   nirK_half_sat_C   nirK_half_sat_N   nirK_deltaG0
    ...
    1   s(’N-’)   1.5   s(‘O’)   1   s(‘null’)   1   s(’N’)   1   s(‘H2O’)   2   s(‘H’)   amoA_sp_growth_rate   amoA_half_sat_N   amoA_half_sat_O   amoA_deltaG0
